...
class ManageUsersController extends Controller
{
    ...
    {
        $pageTitle = 'Users with Products';
        $users     = $this->userData('withProducts');
        return view('admin.users.list', compact('pageTitle', 'users'));
    }
    ...
    public function detail($id)
    {
        ...
        $totalProduct         = Product::approved()->where('user_id', $user->id)->count();
        $totalPurchased       = Sell::approved()->where('user_id', $user->id)->count();
        $totalSoldAmount      = Sell::approved()->where('author_id', $user->id)->sum('product_price');
        $totalPurchasedAmount = Sell::approved()->where('user_id', $user->id)->sum('product_price');

        $countries = json_decode(file_get_contents(resource_path('views/partials/country.json')));
        return view('admin.users.detail', compact('pageTitle', 'user', 'totalDeposit', 'totalWithdrawals', 'totalTransaction', 'countries', 'totalProduct', 'totalPurchased', 'totalSoldAmount', 'totalPurchasedAmount'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $user->top_author = $request->top_author ? Status::YES : Status::NO;
    ...
    {
        $pageTitle = 'Featured Authors';
        $authors   = Featured::with('user')->latest()->paginate(getPaginate());
        return view('admin.users.featured', compact('pageTitle', 'authors'));
    }
    ...
    public function makeFeatured(Request $request)
    {
        ...
        $user = User::where('username', $request->username)->withCount('products')->first();
