...
class GeneralSettingController extends Controller
{
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'timezone'        => 'required',
            'regular'         => 'required|integer|gte:0',
            'extended'        => 'required|integer|gte:0',
        ...
        $general->server_name     = $request->server_name;
        $general->save();
    ...
    public function ftp()
    {
        ...
        return view('admin.setting.ftp', compact('pageTitle', 'setting'));
    }
