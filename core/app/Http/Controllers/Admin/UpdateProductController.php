...
class UpdateProductController extends Controller {
    public function pending() {
        ...
        $products  = TempProduct::where('type', 2)->latest()->with('product:id,update_status', 'category', 'subcategory')->paginate(getPaginate());
        return view('admin.product.update.index', compact('pageTitle', 'products'));
    }
    ...
    public function detail($id) {
        ...
        $tempProduct = TempProduct::where('type', 2)->with('product')->findOrFail($id);
        $product     = Product::approved()->where('update_status', 1)->where('id', $tempProduct->product_id)->firstOrFail();
        $pageTitle   = 'Product Detail';
        return view('admin.product.update.detail', compact('pageTitle', 'product', 'tempProduct'));
    }
    ...
    public function approve($id) {
        ...
        return to_route('admin.update.product.pending')->withNotify($notify);
    }
