...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $widget['total_reviewer']          = Reviewer::count();
        $widget['active_reviewer']         = Reviewer::active()->count();
        $widget['banned_reviewer']         = Reviewer::banned()->count();
        $widget['total_products']          = Product::count();
        $widget['pending_products']        = Product::pending()->count();
        $widget['approved_products']       = Product::approved()->count();
        $widget['softRejected_products']   = Product::softRejected()->count();
        $widget['hardRejected_products']   = Product::hardRejected()->count();
        $widget['resubmitted_products']    = Product::resubmitted()->count();
        $widget['update_pending_products'] = TempProduct::where('type', 2)->count();
        $widget['pending_ticket']          = SupportTicket::whereIN('status', [Status::TICKET_OPEN, Status::TICKET_REPLY])->count();
        $widget['payment_request']         = Deposit::pending()->count();
        $widget['total_sale_amount']       = Sell::approved()->sum('product_price');
        $widget['total_charges']           = Sell::approved()->sum('buyer_fee') + Sell::approved()->sum('level_charge');
        $widget['total_pending_amount']    = Sell::pending()->sum('product_price');
        $widget['total_sold']              = Sell::approved()->count();
