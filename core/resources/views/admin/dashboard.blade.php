...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                value="{{ $deposit['total_deposit_rejected'] }}" title="Rejected Deposits" style="2" link="{{ route('admin.deposit.rejected') }}" icon="fas fa-ban" icon_style="false" color="warning" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget
                value="{{ $general->cur_sym }}{{ showAmount($withdrawals['total_withdraw_amount']) }}" title="Total Withdrawan" style="2" link="{{ route('admin.withdraw.log') }}" icon="lar la-credit-card" color="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget
    ...
    <div class="row gy-4 mt-2">
        ...
        <div class="col-xxl-3 col-sm-6">
            <x-widget-3
                value="{{ showAmount($widget['total_sale_amount']) }} {{ $general->cur_text }}" title="Total Sale Amount" icon="las la-money-bill f-size--56" bg="teal" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget-3
                value="{{ showAmount($widget['total_pending_amount']) }} {{ $general->cur_text }}" title="Total Pending Amount" icon="las la-spinner" bg="16" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget-3
                value="{{ showAmount($widget['total_charges']) }} {{ $general->cur_text }}" title="Total Admin Charge" icon="las la-file-invoice-dollar" bg="indigo" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget-3
                value="{{ showAmount($widget['total_sold']) }} {{ $general->cur_text }}" title="Total Sold" icon="las la-sort-numeric-up-alt" bg="blue" />
        </div>
    </div>
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget-1
                value="{{ $widget['payment_request'] }} " title="Payment Request" icon="las la-money-bill f-size--56" bg="9" />
        </div>
        <div class="col-xl-3 col-md-6 col-sm-12">
            <x-widget-1
                value="{{ $widget['total_products'] }} " title="Total Products" icon="las la-list-ul f-size--56" bg="info" />
        </div>
        <div class="col-xl-3 col-md-6 col-sm-12">
            <x-widget-1
                value="{{ $widget['pending_products'] }} " title="Pending Products" icon="las la-spinner f-size--56" bg="warning" />
        </div>
        <div class="col-xl-3 col-md-6 col-sm-12">
            <x-widget-1
                value="{{ $widget['approved_products'] }} " title="Approved Products" icon="las la-check-square f-size--56" bg="success" />
        </div>
    </div>
    <div class="row gy-4 mt-2">
        <div class="col-xl-3 col-md-6 col-sm-12">
            <x-widget-1
                value="{{ $widget['softRejected_products'] }} " title="Soft Rejected Products" icon="las la-exclamation-triangle f-size--56" bg="6" />
        </div>
        <div class="col-xl-3 col-md-6 col-sm-12">
            <x-widget-1
                value="{{ $widget['hardRejected_products'] }} " title="Hard Rejected Products" icon="las la-ban f-size--56" bg="5" />
        </div>
        <div class="col-xl-3 col-md-6 col-sm-12">
            <x-widget-1
                value="{{ $widget['resubmitted_products'] }} " title="Resubmitted Products" icon="las la-sync-alt f-size--56" bg="19" />
        </div>
        <div class="col-xl-3 col-md-6 col-sm-12">
            <x-widget-1
                value="{{ $widget['update_pending_products'] }} " title="Update Pending Products" icon="las la-hourglass-start f-size--56" bg="11" />
        </div>
    </div>

    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget-3 value="{{ $widget['total_reviewer'] }} " title="Total Reviewers" link="{{ route('admin.reviewers.all') }}" icon="las la-user-tie" bg="1" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget-3 value="{{ $widget['active_reviewer'] }} " title="Active Reviewers" link="{{ route('admin.reviewers.active') }}" icon="las la-user-check" bg="green" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget-3 value="{{ $widget['banned_reviewer'] }} " title="Banned Reviewers" link="{{ route('admin.reviewers.banned') }}" icon="las la-user-times" bg="14" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget-3 value="{{ $widget['pending_ticket'] }} " title="Ticket" link="{{ route('admin.ticket.index') }}" icon="las la-ticket-alt f-size--56" bg="10" />
        </div>
    </div>
