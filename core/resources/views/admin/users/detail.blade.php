            ...
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--info">
                        ...
                        <div class="widget-two__content">
                            ...
                            <p class="text-white">@lang('Total Product')</p>
                        </div>
                        <a class="widget-two__btn" href="{{ route('admin.product.approved') }}?search={{ $user->username }}">@lang('View All')</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--danger">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $totalPurchased }}</h3>
                            <p class="text-white">@lang('Total Purchased')</p>
                        </div>
                        <a class="widget-two__btn" href="{{ route('admin.report.transaction') }}?search={{ $user->username }}">@lang('View All')</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--green">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($totalSoldAmount) }}</h3>
                            <p class="text-white">@lang('Total Sold Amount')</p>
                        </div>
                        <a class="widget-two__btn" href="{{ route('admin.report.transaction') }}?search={{ $user->username }}">@lang('View All')</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--warning">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($totalPurchasedAmount) }}</h3>
                            <p class="text-white">@lang('Total Purchased Amount')</p>
                        </div>
                        <a class="widget-two__btn" href="{{ route('admin.report.transaction') }}?search={{ $user->username }}">@lang('View All')</a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.users.update', [$user->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-2 col-md- col-12">
                            ...
                            <div class="form-group col-xl-2 col-md- col-12">
                                <label>@lang('Make Top Author') </label>
                                <input name="top_author" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Yes')" data-off="@lang('No')" type="checkbox" @if ($user->top_author == 1) checked @endif>
                            </div>
                        </div>
