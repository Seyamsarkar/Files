                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="mb-3 text-end">
                                <button class="btn btn-sm btn-outline--success confirmationBtn" data-question="@lang('Are you sure to approved this product?')" data-action="{{ route('reviewer.update.product.approve', Crypt::encrypt($tempProduct->id)) }}"><i class="las la-check-circle"></i> @lang('Approve') </button>

                                <button class="btn btn-sm btn-outline--danger rejectBtn" data-title="@lang('Are you sure to reject this product?')" data-action="{{ route('reviewer.update.product.reject', Crypt::encrypt($tempProduct->id)) }}"><i class="las la-times-circle"></i> @lang('Reject') </button>
                            </div>
                            <ul class="list-group">
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <span>@lang('Name')</span>
                                    <a href="{{ route('reviewer.product.detail', Crypt::encrypt($tempProduct->product->id)) }}">{{ $tempProduct->name }}</a>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <span>@lang('Message To Reviewer')</span>
