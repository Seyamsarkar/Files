                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="mb-3 text-end">
                                @if ($product->status != Status::PRODUCT_HARD_REJECT)
                                    <button class="btn btn-sm btn-outline--success confirmationBtn" data-question="@lang('Are you sure to approved this product?')" data-action="{{ route('reviewer.product.approve', $product->id) }}" @if ($product->status == Status::PRODUCT_APPROVE) disabled @endif><i class="las la-check-circle"></i> @lang('Approve') </button>

                                    <button class="btn btn-sm btn-outline--warning rejectBtn" data-title="@lang('Are you sure to soft reject this product?')" data-action="{{ route('reviewer.product.soft.reject', $product->id) }}" @if ($product->status == Status::PRODUCT_SOFT_REJECT) disabled @endif><i class="las la-times-circle"></i> @lang('Soft Reject') </button>

                                    <button class="btn btn-sm btn-outline--danger rejectBtn" data-title="@lang('Are you sure to hard reject this product?')" data-action="{{ route('reviewer.product.hard.reject', $product->id) }}"><i class="las la-ban"></i> @lang('Hard Reject') </button>
                                @endif
