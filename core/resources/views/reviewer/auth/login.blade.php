                    ...
                    <div class="login-area">
                        <div class="login-wrapper">
                            ...
                            <div class="login-wrapper__body">
                                <form class="cmn-form mt-30 verify-gcaptcha login-form" action="{{ route('reviewer.login') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="d-flex justify-content-between flex-wrap">
                                        ...
                                        <a class="forget-text" href="{{ route('reviewer.password.reset') }}">@lang('Forgot Password?')</a>
                                    </div>
