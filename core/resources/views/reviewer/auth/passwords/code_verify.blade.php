    ...
    <div class="login-main" style="background-image: url('{{ asset('assets/admin/images/login.jpg') }}')">
        <div class="custom-container d-flex justify-content-center container">
            <div class="login-area">
                ...
                <form class="login-form w-100" action="{{ route('reviewer.password.verify.code') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex justify-content-between flex-wrap">
                        <a class="forget-text" href="{{ route('reviewer.password.reset') }}">@lang('Try to send again')</a>
                    </div>
                    <button class="btn cmn-btn w-100 mt-4" type="submit">@lang('Submit')</button>
                </form>
                <a class="mt-4 text-white" href="{{ route('reviewer.login') }}"><i class="las la-sign-in-alt" aria-hidden="true"></i>@lang('Back to Login')</a>
            </div>
        </div>
    </div>
@endsection
