            ...
            <div class="d-flex justify-content-center">
                <div class="verification-code-wrapper">
                    <div class="verification-area">
                        ...
                        <form class="submit-form" action="{{ route('reviewer.verify.email') }}" method="POST">
                            @csrf
                            <p class="pt-3">@lang('A 6 digit verification code sent to your email address'): {{ showEmailAddress(authReviewer()->email) }}</p>
                            <div class="my-3">
                            ...
                            <div class="mt-3">
                                <p>
                                    @lang('If you don\'t get any code'), <a class="text--base" href="{{ route('reviewer.send.verify.code', 'email') }}"> @lang('Try again')</a>
                                </p>
