                    ...
                    <div class="action-sidebar">
                        ...
                        <div class="action-widget mt-3">
                            ...
                            <div class="action-widget__body">
                                ...
                                <div class="form-check custom--checkbox mb-0">
                                    <input class="form-check-input sortProduct" id="best_rating" name="sort" type="radio" value="totalRating_desc">
                ...
                <div class="col-lg-9">
                    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                        <p>
                            ...
                            @lang('Total') <span class="text--base products-count"></span> @lang('Product Found')
                        </p>
...
@push('script')
    <script>
        (function($) {
            ...
            $('.products-count').text(totalProduct)

            $('.sortProduct, .sortSubcategory, .sortRating, .sortTag').on('click', function() {
            ...
            function fetchProduct() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        totalProduct = $(document).find('.card-view').length;
                        $('.products-count').text(totalProduct)
                    }
                }).done(function() {
                    $('.loader-wrapper').addClass('d-none')
