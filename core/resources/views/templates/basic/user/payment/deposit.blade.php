                    ...
                    <form action="{{ route('user.deposit.insert') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control form--control" name="amount" type="number" value="@if (@$amount){{ getAmount(@$amount) }}@else{{ old('amount') }} @endif" step=" any" autocomplete="off" @if (@$amount) readonly @else required @endif>
...
@push('breadcrumb-plugins')
    <a class="btn btn-sm btn-outline--base" href="{{ route('user.deposit.history') }}">
