    ...
    <div class="row justify-content-center gy-3">
            ...
            <div class="col-md-6">
                <div class="card custom--card">
                    <div class="card-header">
                        <h5 class="card-title m-0 text-center">@lang('Add Your Account')</h5>
                    </div>
        ...
        <div class="col-md-6">
            @if (auth()->user()->ts)
                <div class="card custom--card">
                    <div class="card-header">
                        <h5 class="card-title m-0 text-center">@lang('Disable 2FA Security')</h5>
                    </div>
            ...
            @else
                <div class="card custom--card">
                    <div class="card-header">
                        <h5 class="card-title m-0 text-center">@lang('Enable 2FA Security')</h5>
                    </div>
